...
var ConfigurationWhere = struct {
	...
	Active:     whereHelpernull_Bool{field: "\"booking\".\"configuration\".\"active\""},
	Enable:     whereHelpernull_Bool{field: "\"booking\".\"configuration\".\"enable\""},
	ProjectIds: whereHelpertypes_StringArray{field: "\"booking\".\"configuration\".\"project_ids\""},
	UserID:     whereHelpernull_String{field: "\"booking\".\"configuration\".\"user_id\""},
}
...
type configurationR struct {
	ConfigEvents EventSlice `boil:"ConfigEvents" json:"ConfigEvents" toml:"ConfigEvents" yaml:"ConfigEvents"`
}
...
func (r *configurationR) GetConfigEvents() EventSlice {
	if r == nil {
		return nil
	}
	return r.ConfigEvents
}
...
var (
	...
	configurationColumnsWithDefault    = []string{"id", "active", "enable", "project_ids", "user_id"}
...
// ConfigEvents retrieves all the event's Events with an executor via config_id column.
func (o *Configuration) ConfigEvents(mods ...qm.QueryMod) eventQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"booking\".\"event\".\"config_id\"=?", o.ID),
	)

	return Events(queryMods...)
}

// LoadConfigEvents allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (configurationL) LoadConfigEvents(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`booking.event.config_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ConfigEvents = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ConfigID {
				local.R.ConfigEvents = append(local.R.ConfigEvents, foreign)
				if foreign.R == nil {
					foreign.R = &eventR{}
				}
...
// AddConfigEventsG adds the given related objects to the existing relationships
// of the configuration, optionally inserting them as new records.
// Appends related to o.R.ConfigEvents.
// Sets related.R.Config appropriately.
// Uses the global database handle.
func (o *Configuration) AddConfigEventsG(ctx context.Context, insert bool, related ...*Event) error {
	return o.AddConfigEvents(ctx, boil.GetContextDB(), insert, related...)
}

// AddConfigEvents adds the given related objects to the existing relationships
// of the configuration, optionally inserting them as new records.
// Appends related to o.R.ConfigEvents.
// Sets related.R.Config appropriately.
func (o *Configuration) AddConfigEvents(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Event) error {
	var err error
	...
	if o.R == nil {
		o.R = &configurationR{
			ConfigEvents: related,
		}
	} else {
		o.R.ConfigEvents = append(o.R.ConfigEvents, related...)
	}
