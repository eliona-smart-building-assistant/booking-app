...
type Configuration struct {
	...
	StartBookableHours int32 `boil:"start_bookable_hours" json:"start_bookable_hours" toml:"start_bookable_hours" yaml:"start_bookable_hours"`
	StartBookableMins  int32 `boil:"start_bookable_mins" json:"start_bookable_mins" toml:"start_bookable_mins" yaml:"start_bookable_mins"`
	EndBookableHours   int32 `boil:"end_bookable_hours" json:"end_bookable_hours" toml:"end_bookable_hours" yaml:"end_bookable_hours"`
	EndBookableMins    int32 `boil:"end_bookable_mins" json:"end_bookable_mins" toml:"end_bookable_mins" yaml:"end_bookable_mins"`
...
var ConfigurationColumns = struct {
	ID                 string
	StartBookableHours string
	StartBookableMins  string
	EndBookableHours   string
	EndBookableMins    string
}{
	ID:                 "id",
	StartBookableHours: "start_bookable_hours",
	StartBookableMins:  "start_bookable_mins",
	EndBookableHours:   "end_bookable_hours",
	EndBookableMins:    "end_bookable_mins",
}
...
var ConfigurationTableColumns = struct {
	...
	ID:                 "configuration.id",
	StartBookableHours: "configuration.start_bookable_hours",
	StartBookableMins:  "configuration.start_bookable_mins",
	EndBookableHours:   "configuration.end_bookable_hours",
	EndBookableMins:    "configuration.end_bookable_mins",
}
...
var ConfigurationWhere = struct {
	ID                 whereHelperint64
	StartBookableHours whereHelperint32
	StartBookableMins  whereHelperint32
	EndBookableHours   whereHelperint32
	EndBookableMins    whereHelperint32
}{
	ID:                 whereHelperint64{field: "\"booking\".\"configuration\".\"id\""},
	StartBookableHours: whereHelperint32{field: "\"booking\".\"configuration\".\"start_bookable_hours\""},
	StartBookableMins:  whereHelperint32{field: "\"booking\".\"configuration\".\"start_bookable_mins\""},
	EndBookableHours:   whereHelperint32{field: "\"booking\".\"configuration\".\"end_bookable_hours\""},
	EndBookableMins:    whereHelperint32{field: "\"booking\".\"configuration\".\"end_bookable_mins\""},
}
...
var (
	configurationAllColumns            = []string{"id", "start_bookable_hours", "start_bookable_mins", "end_bookable_hours", "end_bookable_mins"}
	configurationColumnsWithoutDefault = []string{"start_bookable_hours", "start_bookable_mins", "end_bookable_hours", "end_bookable_mins"}
	configurationColumnsWithDefault    = []string{"id"}
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"booking\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"booking\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"booking\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"booking\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"booking\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"booking\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"booking\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"booking\".\"configuration\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"booking\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"booking\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"booking\".\"configuration\".* FROM \"booking\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"booking\".\"configuration\" where \"id\"=$1 limit 1)"
